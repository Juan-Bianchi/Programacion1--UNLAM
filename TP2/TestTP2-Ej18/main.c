/*Ejercicio 18
Ingrese hasta un m�ximo de 1000 caracteres (o hasta que se ingrese el car�cter
'.'. Mostrar por pantalla el car�cter inmediato posterior
(p. ej.: "a bgxj" ->"b!chyk"; "Zapato" -> "[bqbup"). Grabar en un archivo aquellas palabras con m�s de una determinada cantidad de letras que se
